...
<sql:setDataSource var="dataSource"
	...
	driver="oracle.jdbc.driver.OracleDriver" user="apt" password="1234" /> 
...
<body onload="init()">
	...
	<div class="container">
		<form name="newMember" class="form-horizontal" action="memberUpdateProcess.jsp" 
			...
			<div class="form-group  row">
				...
				<div><span class="badge badge-pill badge-danger">*Required</span></div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4  ">
					<input type="text" name="birthyy" maxlength="4" placeholder="년(4자리)" 	size="6" value="${year}"> 
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="phone" type="text" class="form-control" placeholder="" value="<c:out value='${row.phone}'/>">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<input name="address" type="text" class="form-control" placeholder="" value="<c:out value='${row.address}'/>">
				</div>
			</div>
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<input type="submit" class="btn btn-primary" value="회원수정 "> 
					<a href="memberDelete.jsp" class="btn btn-danger">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
